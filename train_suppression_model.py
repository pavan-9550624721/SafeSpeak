...
def synthesize_suppression_dataset():
    ...
    feature_names = (
        ["toxic", "very_toxic", "obscene", "threat", "insult", "hate", "spam_prob"]
        + list(saf_classes)
        + ["engagement_ratio", "watch_time_percent"]
    )
...
def main():
    ...
    print(
        "Saved Calibrated Suppression Meta-Classifier to models/suppression_model.pkl"
    )
